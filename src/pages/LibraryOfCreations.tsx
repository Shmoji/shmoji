...
const LibraryOfCreations = () => {
  return (
    <div className="flex flex-col items-center">
      <div className="text-4xl font-bold mb-8">Library of Creations</div>
      <div className="mb-8 mx-4">A project with the goal of simply sharing creations of the mind.</div>
