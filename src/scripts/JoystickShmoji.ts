import { Behaviour, EventList, IPointerDownHandler, IPointerMoveHandler, IPointerUpHandler, Input, Mathf, PointerEventData, Rect, RectTransform, registerType, serializable } from "@needle-tools/engine";
...
@registerType
export class JoystickShmoji extends Behaviour implements IPointerDownHandler, IPointerUpHandler
{
